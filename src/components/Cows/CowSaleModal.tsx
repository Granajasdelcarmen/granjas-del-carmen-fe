...
export function CowSaleModal({ 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.message || 'Error al vender la vaca');
    }
  };
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Vender Vaca">
      <div className="space-y-4">
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <p className="text-sm text-green-800">
            <strong>💰 Venta:</strong> Estás a punto de vender la vaca <strong>{cow.name}</strong>.
